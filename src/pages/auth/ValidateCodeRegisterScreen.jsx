...
export const ValidateCodeRegisterScreen = () => {
	const { handleFormValidateCode, submitFormValidateCode, submitResendCode, submitFormValidateCodeRegister } = useAuth()
		...
		<div className='w-full relative h-screen bg-red-50 flex'>
			...
			<div className='p-6 bg-white absolute right-0 w-3/6 h-screen flex flex-col justify-center'>
				...
				<form
					...
					onSubmit={handleSubmit((data, event) => submitFormValidateCodeRegister(data, event))}
				>
					<InputComponent
						color
						register={register}
