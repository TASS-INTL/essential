...
export const PersonalData = () => {
  const { valuePersonalData, handlePersonalData, submitFormValidateData } =
    useAuth();
  const [flagInput, setFlagInput] = useState(false);
  const [value, setValue] = useState();

  const [chekInput, setChekInput] = useState(
    valuePersonalData.terms_conditions
  );
                ...
                <>
                  <div className="box-label">
                    ...
                    >
                      ...
                      <option value={typeDocument.RC}>{typeDocument.RC}</option>
                      <option value={typeDocument.PA}>{typeDocument.PA}</option>
                      <option value={typeDocument.NIT}>
                        {typeDocument.NIT}
                      </option>
                      <option value={typeDocument.SSN}>
                        {typeDocument.SSN}
                      </option>
                      <option value={typeDocument.NUIP}>
                        {typeDocument.NUIP}
                      </option>
                      <option value={typeDocument.DNI}>
                        {typeDocument.DNI}
                      </option>
                      <option value={typeDocument.NN}>{typeDocument.NN}</option>
                    </select>
