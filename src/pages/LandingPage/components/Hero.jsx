...
const Hero = () => {
	...
	return (
		<section
			...
			id='home'
			className={`flex md:flex-row flex-col ${styles.paddingY}  relative flex  w-full items-center justify-center overflow-hidden rounded-xl bg-gradient-to-r from-black to-slate-950 px-8  shadow-2xl`}
		>
			<div
